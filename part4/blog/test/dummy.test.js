...
describe('mostBlogs', () => {
  ...
  test('when list has no blogs, equals to empty object', () => {
    assert.deepStrictEqual(listHelper.mostBlogs(noBlogs), {})
  })

  test('when list has one blogs, equals to author and blogs equals to 1', () => {
  ...
  test('when list has multiple blogs, shows the author with the most blogs', () => {
...
describe('mostLikes', () => {
  ...
  test('when list has no blogs, equals to empty object', () => {
    assert.deepStrictEqual(listHelper.mostLikes(noBlogs), {})
  })

  test('when list has one blog, equals to author and blogs equals to likes', () => {
  ...
  test('when list has multiple blogs, shows the author with the most likes', () => {
